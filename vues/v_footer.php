                            ...
                            <?php if (isset($_SESSION['login'])) {
                                ...
                                <li class="pb-2 dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-dark p-0">
                                        <li><a class="dropdown-item" href="index.php?uc=saisirRapport&action=choixRedaction">Rédiger un rapport</a></li>
                                        <li><a class="dropdown-item" href="index.php?uc=consulterRapports&action=mesrapports">Mes rapports</a></li>';
                                if ($_SESSION['habilitation'] == 2) echo '<li><a class="dropdown-item" href="index.php?uc=consulterRapportsRegion&action=rapportRegion">Rapport de ma région</a></li>';
                                echo '</ul>
                                </li>
                                <li class="pb-2">
